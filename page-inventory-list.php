...
<div class="inventory-availability-filter"><span id="inventory-available-label">فقط کالاهای موجود</span><input class="inventory-switch" type="checkbox" name="available" value="1" aria-labelledby="inventory-available-label" <?php checked($only_available); ?>></div>
</form></div>
