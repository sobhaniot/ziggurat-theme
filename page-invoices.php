    ...
    <?php else: ?>
        <section class="invoice-workspace">
            ...
            <?php if ($view === 'form'): ?>
                ...
                <form class="invoice-editor <?php echo current_user_can('manage_options') ? '' : 'invoice-editor--payment-readonly'; ?>" method="post" data-invoice-editor data-invoice-unsaved="<?php echo $form_error ? '1' : '0'; ?>">
